        ...
        <div className="flex flex-col flex-1 justify-center items-center h-screen">
            <div className="w-96">
                <div className="flex flex-col gap-2">
                    <div className="text-4xl text-center">Create an account</div>
                    <div className="text-lg text-gray-500 text-center">Start your journey!</div>
                </div>
                <form className="flex flex-col w-full text-lg gap-4 mt-10">
                    ...
                    <button className={`bg-[#1F252B] text-white ${buttonBase}`} type="submit">Get Started</button>
