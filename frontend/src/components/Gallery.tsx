...
const Gallery = () => {
  ...
  return (
    <>
      <div className=" bg-[#3B3682] w-full min-h-200 rounded-3xl px-10 py-10 gap-20">
        <div className="text-3xl font-bold text-indigo-300">Post Gallery</div>
        <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-4 justify-center place-items-center">
          ...
          <div className="border-2 bg-white p-4 rounded-lg max-w-xl w-full">
            ...
            <div className="flex justify-between mt-4">
              <h2 className="text-xl font-bold">
                User {imageData[currentImageIndex].authorId}'s Sketch{" "}
                {imageData[currentImageIndex].id}
              </h2>
